...
const businessAccessLayer = {
    ...
    async createBusiness({businessName, userId, facebookPageId, googlePlaceId, trustpilotBusinessUnitId, yelpBusinessId}) {
        const results = await pool.query(
            ...
            [businessName, userId, facebookPageId, googlePlaceId, trustpilotBusinessUnitId, yelpBusinessId]
        );
    ...
    async updateBusinessPlatformIds(businessId, {facebookPageId, googlePlaceId, trustpilotBusinessUnitId, yelpBusinessId}) {
        const results = await pool.query(
            `UPDATE businesses 
            SET 
            ...
            [businessId, facebookPageId, googlePlaceId, trustpilotBusinessUnitId, yelpBusinessId]
        );
        return results.rows[0];
    }
};
